...
# Define paths
alltime_socmed_dir = Path("data/alltime_socmed")
alltime_dir = Path("data/alltime")
...
with open('improved_eda.py', 'r') as f:
    content = f.read()
# Replace any existing alltime file path with the static one
import re
content = re.sub(r'data_path="data/alltime/alltime_socmed(?:_\d{8}_\d{6})?\.csv"', 
                'data_path="data/alltime/alltime_socmed.csv"', content)
with open('improved_eda.py', 'w') as f:
    f.write(content)

# Update interactive_eda.py
with open('interactive_eda.py', 'r') as f:
    content = f.read()
# Replace any existing alltime file path with the static one
content = re.sub(r'data_path="data/alltime/alltime_socmed(?:_\d{8}_\d{6})?\.csv"', 
                'data_path="data/alltime/alltime_socmed.csv"', content)
with open('interactive_eda.py', 'w') as f:
    f.write(content)
